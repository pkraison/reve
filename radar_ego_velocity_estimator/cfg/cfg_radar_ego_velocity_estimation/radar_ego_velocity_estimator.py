...
def configure(gen):
    ...
    radar_refiner.add("elevation_thresh_deg", double_t, 0, "Absolute elevation angle threshold", 85, 0, 100)
    radar_refiner.add("azimuth_thresh_deg", double_t, 0, "Absolute azimuth angle threshold", 85, 0, 100)
